import { LucideIcon, Cpu, Zap, PenTool, LayoutGrid, Search, Microchip, Battery, Cable, Wifi } from "lucide-react";
...
export const CATEGORIES: Category[] = [
  { id: "1", name: "Vi điều khiển", icon: Cpu, type: "active" },
  { id: "2", name: "Cảm biến", icon: Wifi, type: "active" },
  { id: "3", name: "Nguồn & Pin", icon: Battery, type: "passive" },
  { id: "4", name: "Dây & Cáp", icon: Cable, type: "passive" },
  { id: "5", name: "Dụng cụ", icon: PenTool, type: "tools" },
  { id: "6", name: "IC số", icon: Microchip, type: "active" },
];
